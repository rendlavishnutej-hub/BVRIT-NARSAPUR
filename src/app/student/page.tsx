...
export default function StudentDashboard() {
  return (
    <div>
      <div className="mb-8">
        <h1 className="font-heading text-3xl font-bold text-charcoal">Welcome back! ðŸ‘‹</h1>
      ...
      <div className="bg-white rounded-2xl p-8 shadow-soft border border-soft-peach/20 mb-8">
        <h2 className="font-heading text-xl font-bold mb-6">ðŸ“– My Learning Quest</h2>
        <div className="space-y-4">
          {[
            { emoji: 'ðŸŒ±', name: 'Letter Explorer', status: 'completed', progress: 100 },
            { emoji: 'ðŸ”¤', name: 'Word Builder', status: 'completed', progress: 100 },
            { emoji: 'ðŸ“–', name: 'Sentence Navigator', status: 'completed', progress: 100 },
            { emoji: 'ðŸ“š', name: 'Paragraph Explorer', status: 'current', progress: 72 },
            { emoji: 'ðŸ°', name: 'Story Master', status: 'locked', progress: 0 },
          ].map((stage) => (
              ...
              <div className="flex-1">
                <div className="flex items-center justify-between mb-1">
                  ...
                  <span className="text-xs text-charcoal-lighter">
                    {stage.status === 'completed' ? 'âœ“' : stage.status === 'locked' ? 'ðŸ”’' : `${stage.progress}%`}
                  </span>
                </div>
